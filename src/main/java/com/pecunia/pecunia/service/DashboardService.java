...
public class DashboardService {
    ...
    public DashboardResponse getDashboardData(String userEmail) {
        ...
        List<Transaction> transactions = transactionRepository
                .findByAccount_UserAndTransactionDateBetweenOrderByTransactionDateDesc(user, startDate, endDate);
        ...
        response.setTotalIncome(totals.getOrDefault("INCOME", BigDecimal.ZERO));
        response.setTotalExpense(totals.getOrDefault("EXPENSE", BigDecimal.ZERO));
